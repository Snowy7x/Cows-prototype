...
namespace Systems.IK.Base
{
    [Serializable] public class ChainIK
    {
        ...
        public void Init()
        {
            ...
            if (useJoint)
            {
                joints = new ConfigurableJoint[ChainLength + 1];
                for (int i = 0; i < joints.Length; i++)
                {
                    joints[i] = Bones[i + 1].GetComponent<ConfigurableJoint>();
                }
            }
        ...
        public  void ResolveIK()
        {
            ...
            for (int i = 0; i < Positions.Length; i++)
            {
                ...
                else
                {
                    if (i == Positions.Length - 1)
                    {
                        joints[i].targetRotation = targetRotation;
                    }
                    else
                    {
                    ...
                    if (!onlyRotate) joints[i].targetPosition = Positions[i];
                }
            }
        }
